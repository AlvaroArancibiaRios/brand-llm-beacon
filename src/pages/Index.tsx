              ...
              {!showResults && !isAnalyzing && (
                <div className="w-full max-w-4xl">
                  <div className="border border-border/20 bg-background/50 backdrop-blur-xl rounded-3xl p-12 text-center">
                    <div className="h-16 w-16 rounded-full bg-gradient-primary/10 flex items-center justify-center mx-auto mb-6">
                      <Search className="h-8 w-8 text-primary" />
                    </div>
                    <h3 className="text-xl font-semibold mb-3">Listo para Analizar</h3>
                    ...
                    <div className="border border-border/20 bg-background/50 backdrop-blur-xl rounded-3xl p-8">
                      ...
                      <div className="space-y-4">
                        {mockLLMData.map((model) => (
                          <div key={model.model} className="p-4 rounded-2xl border border-border/20 bg-background/30 backdrop-blur-sm">
